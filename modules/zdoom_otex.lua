...
OTEX_SINK_BASES =
{
  OLGHTA01 = {dz = 128, color = "white"},
  OLGHTA02 = {dz = 128, color = "yellow"},
  OLGHTA03 = {dz = 128, color = "orange"},
  OLGHTA04 = {dz = 128, color = "blue"},
  OLGHTA05 = {dz = 128, color = "purple"},
  OLGHTA06 = {dz = 128, color = "green"},
  OLGHTA07 = {dz = 128, color = "red"},

  OLGHTB01 = {dz = 8, color = "white"},
  OLGHTB02 = {dz = 8, color = "beige"},
  OLGHTB03 = {dz = 8, color = "yellow"},
  OLGHTB04 = {dz = 8, color = "orange"},
  OLGHTB05 = {dz = 8, color = "red"},
  OLGHTB06 = {dz = 8, color = "violet"},
  OLGHTB07 = {dz = 8, color = "blue"},
  OLGHTB08 = {dz = 8, color = "green"},

  OLGHTC01 = {dz = 128, color = "white"},
  OLGHTC02 = {dz = 64, color = "white"},
  OLGHTC03 = {dz = 128, color = "beige"},
  OLGHTC04 = {dz = 64, color = "beige"},
  OLGHTC05 = {dz = 128, color = "green"},
  OLGHTC06 = {dz = 64, color = "green"},
  OLGHTC07 = {dz = 128, color = "red"},
  OLGHTC08 = {dz = 64, color = "red"},
  --
  OLGHTC11 = {dz = 64, color = "white"},
  OLGHTC13 = {dz = 64, color = "beige"},
  OLGHTC15 = {dz = 64, color = "green"},
  OLGHTC17 = {dz = 64, color = "red"},
  --
  OLGHTD01 = {dz = 64, color = "white"},
  OLGHTD02 = {dz = 32, color = "white"},
  OLGHTD03 = {dz = 64, color = "yellow"},
  OLGHTD04 = {dz = 32, color = "yellow"},
  OLGHTD05 = {dz = 64, color = "green"},
  OLGHTD06 = {dz = 32, color = "green"},
  --
  OLGHTF01 = {dz = 64, color = "white"},
  OLGHTF02 = {dz = 16, color = "white"},
  OLGHTF03 = {dz = 64, color = "yellow"},
  OLGHTF04 = {dz = 16, color = "yellow"},
  OLGHTF05 = {dz = 64, color = "green"},
  OLGHTF06 = {dz = 16, color = "green"},
  OLGHTF07 = {dz = 64, color = "orange"},
  OLGHTF08 = {dz = 16, color = "orange"},
  OLGHTF09 = {dz = 64, color = "blue"},
  OLGHTF10 = {dz = 16, color = "blue"},
  OLGHTF11 = {dz = 64, color = "red"},
  OLGHTF12 = {dz = 16, color = "red"},
  --
  OLGHTG34 = {dz = 64, color = "yellow"},
  OLGHTG35 = {dz = 64, color = "blue"},
  OLGHTG36 = {dz = 64, color = "orange"},
  OLGHTG37 = {dz = 64, color = "green"},
  OLGHTG38 = {dz = 64, color = "beige"},
  OLGHTG39 = {dz = 64, color = "white"},
  OLGHTG3A = {dz = 64, color = "red"},
  --
  OLGHTK01 = {dz = 8},
  OLGHTK02 = {dz = 8},
  OLGHTK03 = {dz = 8},
  OLGHTK04 = {dz = 8},
  OLGHTK05 = {dz = 8},
  OLGHTK06 = {dz = 8, color = "purple"},
  OLGHTK07 = {dz = 8},
  OLGHTK08 = {dz = 8},
  --
  OLGHTL01 = {dz = 16, color = "white"},
  OLGHTL02 = {dz = 16, color = "red"},
  OLGHTL03 = {dz = 16, color = "green"},
  OLGHTL04 = {dz = 16, color = "blue"},
  OLGHTL05 = {dz = 16, color = "yellow"},
  OLGHTL06 = {dz = 16, color = "purple"},
  OLGHTL07 = {dz = 16},
  OLGHTL08 = {dz = 16, color = "orange"},
  --
  OLGHTM11 = {dz = 8, color = "white"},
  OLGHTM12 = {dz = 8, color = "white"},
  OLGHTM19 = {dz = 8, color = "white"},
  OLGHTM21 = {dz = 8, color = "beige"},
  OLGHTM22 = {dz = 8, color = "beige"},
  OLGHTM29 = {dz = 8, color = "beige"},
  OLGHTM31 = {dz = 8, color = "yellow"},
  OLGHTM32 = {dz = 8, color = "yellow"},
  OLGHTM39 = {dz = 8, color = "yellow"},
  OLGHTM41 = {dz = 8, color = "orange"},
  OLGHTM42 = {dz = 8, color = "orange"},
  OLGHTM49 = {dz = 8, color = "orange"},
  OLGHTM51 = {dz = 8, color = "red"},
  OLGHTM52 = {dz = 8, color = "red"},
  OLGHTM59 = {dz = 8, color = "red"},
  OLGHTM61 = {dz = 8, color = "purple"},
  OLGHTM62 = {dz = 8, color = "purple"},
  OLGHTM69 = {dz = 8, color = "purple"},
  OLGHTM71 = {dz = 8, color = "blue"},
  OLGHTM72 = {dz = 8, color = "blue"},
  OLGHTM79 = {dz = 8, color = "blue"},
  OLGHTM81 = {dz = 8, color = "green"},
  OLGHTM82 = {dz = 8, color = "green"},
  OLGHTM89 = {dz = 8, color = "green"},
  --
  OLGHTO01 = {dz = 64, color = "beige"},
  OLGHTO02 = {dz = 64, color = "green"},
  OLGHTO03 = {dz = 64, color = "white"},
  OLGHTO04 = {dz = 64, color = "yellow"},
  OLGHTO05 = {dz = 64, color = "red"},
  OLGHTO11 = {dz = 64, color = "beige"},
  OLGHTO12 = {dz = 64, color = "green"},
  OLGHTO13 = {dz = 64, color = "white"},
  OLGHTO14 = {dz = 64, color = "yellow"},
  OLGHTO15 = {dz = 64, color = "red"},
  --
  OLGHTP01 = {dz = 64, color = "orange"},
  OLGHTP02 = {dz = 64, color = "green"},
  OLGHTP03 = {dz = 64, color = "white"},
  OLGHTP04 = {dz = 64, color = "yellow"},
  OLGHTP05 = {dz = 64, color = "red"},

  OLGHTQ01 = {dz = 128, color = "white"},
  OLGHTQ02 = {dz = 128, color = "beige"},
  OLGHTQ03 = {dz = 128, color = "yellow"},
  OLGHTQ04 = {dz = 128, color = "orange"},
  OLGHTQ05 = {dz = 128, color = "red"},
  OLGHTQ06 = {dz = 128, color = "purple"},
  OLGHTQ07 = {dz = 128, color = "blue"},
  OLGHTQ08 = {dz = 128, color = "green"},
  --
  OLGHTQ0X = {dz = 64},
  OLGHTQ11 = {dz = 64, color = "white"},
  OLGHTQ12 = {dz = 64, color = "beige"},
  OLGHTQ13 = {dz = 64, color = "yellow"},
  OLGHTQ14 = {dz = 64, color = "orange"},
  OLGHTQ15 = {dz = 64, color = "red"},
  OLGHTQ16 = {dz = 64, color = "purple"},
  OLGHTQ17 = {dz = 64, color = "blue"},
  OLGHTQ18 = {dz = 64, color = "green"},

  OMETLC80 = {dz = 128, color = "green"},
  OMETLC81 = {dz = 128, color = "yellow"},
  OMETLC82 = {dz = 64, color = "green"},
  OMETLC83 = {dz = 64, color = "yellow"},
...
function OTEX_PROC_MODULE.synthesize_procedural_themes()
  ...
  for name,info in pairs(OTEX_SINK_BASES) do
    ...
    if info.color then
      GAME.SINKS[sink_name].light_color = info.color
    end

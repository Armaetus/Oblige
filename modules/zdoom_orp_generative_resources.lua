...
OBS_RESOURCE_PACK_GENAI_MATERIALS =
{
  ...
  -- TECH --
  -- techy grey walls
  G_OM_WL1 = { t="G_OM_WL1", f="SDOM_FT1"},
  G_OM_WL2 = { t="G_OM_WL2", f="SDOM_FT2"},
  G_OM_WL3 = { t="G_OM_WL3", f="SDOM_FT3"},
  G_OM_WL4 = { t="G_OM_WL4", f="SDOM_FT4"},
  G_OM_WL5 = { t="G_OM_WL5", f="SDOM_FT5"},
  G_OM_WL6 = { t="G_OM_WL6", f="SDOM_FT6"},
  G_OM_WL7 = { t="G_OM_WL7", f="SDOM_FT7"},
  G_OM_WL8 = { t="G_OM_WL8", f="SDOM_FT8"},
  G_OM_WL9 = { t="G_OM_WL9", f="SDOM_FT9"},
  G_OM_WLA = { t="G_OM_WLA", f="SDOM_FTA"},
  G_OM_WLB = { t="G_OM_WLB", f="SDOM_FT1"},
  G_OM_WLC = { t="G_OM_WLC", f="SDOM_FT2"},
  G_OM_WLD = { t="G_OM_WLD", f="SDOM_FT3"},
  G_OM_WLE = { t="G_OM_WLE", f="SDOM_FT4"},
  -- green
  G_OM_WG1 = { t="G_OM_WG1", f="SDOM_FG1"},
  G_OM_WG2 = { t="G_OM_WG2", f="SDOM_FG2"},
  G_OM_WG3 = { t="G_OM_WG3", f="SDOM_FT1"},
  G_OM_WG4 = { t="G_OM_WG4", f="SDOM_FT2"},
  G_OM_WG5 = { t="G_OM_WG5", f="SDOM_FT3"},
  G_OM_WG6 = { t="G_OM_WG6", f="SDOM_FT4"},
  G_OM_WG7 = { t="G_OM_WG7", f="SDOM_FG1"},
  G_OM_WG8 = { t="G_OM_WG8", f="SDOM_FG2"},
  -- dark green
  ...
  -- flats
  SDOM_FT1 = { t="G_OM_WL1", f="SDOM_FT1"},
  SDOM_FT2 = { t="G_OM_WL2", f="SDOM_FT2"},
  SDOM_FT3 = { t="G_OM_WL3", f="SDOM_FT3"},
  SDOM_FT4 = { t="G_OM_WL4", f="SDOM_FT4"},
  SDOM_FT5 = { t="G_OM_WL3", f="SDOM_FT5"},
  SDOM_FT6 = { t="G_OM_WL2", f="SDOM_FT6"},
  SDOM_FT7 = { t="G_OM_WL1", f="SDOM_FT7"},
  SDOM_FT8 = { t="G_OM_WL4", f="SDOM_FT8"},
  SDOM_FT9 = { t="G_OM_WL2", f="SDOM_FT9"},
  SDOM_FTA = { t="G_OM_WL3", f="SDOM_FTA"},
  -- flats: green
  SDOM_FG1 = { t="G_OM_WG1", f="SDOM_FG1"},
  SDOM_FG2 = { t="G_OM_WG2", f="SDOM_FG2"},

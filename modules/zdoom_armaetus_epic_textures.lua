...
function OBS_RESOURCE_PACK_EPIC_TEXTURES.put_the_texture_wad_in()
  ...
  if PARAM.bool_include_package == 1 then
    ...
    gui.wad_insert_file(dir .. "ADVCR6.png", "ADVCR6")
    ...
    gui.wad_insert_file(dir .. "ADVMS1.png", "ADVMS1")
    gui.wad_insert_file(dir .. "ADVMS2.png", "ADVMS2")
    gui.wad_insert_file(dir .. "ADVMS3.png", "ADVMS3")
    gui.wad_insert_file(dir .. "ADVMS2B.png", "ADVMS2B")
    gui.wad_insert_file(dir .. "ADVERTBR.png", "ADVERTBR")
